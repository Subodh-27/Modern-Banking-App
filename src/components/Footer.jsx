...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      ...
      <div className="flex-[1.5] w-full flex flex-row flex-wrap justify-between md:mt-0 mt-10">
        {footerLinks.map((footerLink) => (
          ...
          >
            <h4 className="font-medium text-[18px] leading-[27px] text-white font-poppins">
              {footerLink.title}
            </h4>
    ...
    <div className="flex flex-col items-center justify-between w-full pt-6 border-t-[1px] border-t-[#3f3e45] md:flex-row">
      <p className="font-normal text-center text-[18px] leading-[27px] text-white font-poppins">
